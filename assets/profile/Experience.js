        ...
        <React.StrictMode>
            <div style={BlockExp}>
                ...
                </div>
                {
                    expData.map(
                        (d)=>(
                            <div><BlockExperience dataE={d} /><br/></div>
                        )
                    )
                }
            </div>
